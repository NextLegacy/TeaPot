...
public final class ANSICode 
{
    ...
    //private static final String FOREGROUND(int rgb)     { return FOREGROUND((rgb & 0xff0000) >> 16, (rgb & 0x00ff00) >> 8, rgb & 0x0000ff); }
    //private static final String FOREGROUND(Color color) { return FOREGROUND( color.r              , color.g              , color.b       ); }

    private static final String BACKGROUND(int r, int g, int b) { return "48;2;" + r + ";" + g + ";" + b; }
    //private static final String BACKGROUND(int rgb)     { return BACKGROUND((rgb & 0xff0000) >> 16, (rgb & 0x00ff00) >> 8, rgb & 0x0000ff); }
    //private static final String BACKGROUND(Color color) { return BACKGROUND( color.r              , color.g              , color.b       ); }
    ...
    public static class ANSICodeBuilder
    {
