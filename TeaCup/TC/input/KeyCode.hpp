...
namespace TC
{
    ...
    extern std::map<KeyCode        , std::string> KeyCodeToStringMap        ;
    extern std::map<ModifierCode   , std::string> ModifierCodeToStringMap   ;
    extern std::map<ActionCode     , std::string> ActionCodeToStringMap     ;
    extern std::map<MouseButtonCode, std::string> MouseButtonCodeToStringMap;

    // TODO: maybe use templates here?
    // something like template<typename T> std::string ToString(T);
    ...
    // TODO: support for other input devices
